...
public class ShooterSubsysConfig extends SubsystemConfig {
    ...
    private final int ShooterMainId = SHOOTER_MAIN_MOTOR_CANID.getCanID(); //TODO replace PROTO with these
    private final int ShooterEnglishId = SHOOTER_ENGLISH_MOTOR_CANID.getCanID(); //TODO replace PROTO with these
